...
<div style="margin-bottom: 40px;">
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
		...
		<tr>
			...
			<th class="td" scope="col" style="text-align:<?php echo $text_align; ?>;"><?php _e( 'sorte', 'woocommerce-german-market' ); ?></th>
		...
		?>
 	 	 	...
 	 	 	<tr>
      <p>Vielen Dank, dass du grischberli.de magst!<br>
Viele Grüße aus Kronach bei Fürth,<br>
Jakob & Eva<br><br>
PS: Wir versenden übrigens immer Dienstags und Donnerstags, je nachdem beträgt die Versanddauer zwischen 2 bis 6 Tagen.
    </p>
    </tr>
	</table>
</div>
