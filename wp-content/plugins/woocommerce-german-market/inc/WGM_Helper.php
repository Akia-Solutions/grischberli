	...
	*/
	...
	public static function get_translatable_options() {
		...
		if ( isset( $add_ons[ 'woocommerce-invoice-pdf' ] ) ) {
			...
			$options[ 'wp_wc_invoice_pdf_emails_link_text' ] 					= __( 'Please use the following link to download your invoice PDF: {invoice_download_link}', 'woocoommerce-german-market' );
