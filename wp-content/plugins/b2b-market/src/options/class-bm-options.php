...
class BM_Options {
			...
			<div class='b2b-market'>
				<div class="b2b-market-left-menu">
					<div class="logo"></div>
						...
						<?php echo __( sprintf( 'Version %s', '1.0.8.2' ), 'b2b-market' );?>
					</div>
					</div>
	...
	public function price_display_tab() {
		...
		$options = array(
			...
			array(
				'name'        => __( 'Cart Discount', 'b2b-market' ),
			...
			array(
				...
				'default'           => __( 'You will save [percent] % compared to the original price of [old-price]', 'b2b-market' ),
			),
			array(
				'type' => 'sectionend',
