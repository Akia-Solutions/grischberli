...
if ( ! class_exists( 'IE' ) ) {
	...
	class IE {
		...
		public static function exporter_scripts() {
			...
			wp_register_script( 'cookie-js', untrailingslashit( plugin_dir_url( __FILE__ ) ) . '/assets/cookie.js', array( 'jquery' ), '1.0.8.2', true );
			wp_register_script( 'modal-js', untrailingslashit( plugin_dir_url( __FILE__ ) ) . '/assets/easyModal.js', array( 'jquery' ), '1.0.8.2', true );
			wp_register_script( 'export-js', untrailingslashit( plugin_dir_url( __FILE__ ) ) . '/assets/admin.js', array( 'jquery', 'cookie-js' ), '1.0.8.2', true );
