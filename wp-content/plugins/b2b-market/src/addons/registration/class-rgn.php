	...
	class RGN {
		...
		public static function registration_scripts() {
			...
			if ( is_account_page() || is_checkout() || true === $is_modal ) {
				wp_enqueue_style( 'frontend-registration-css', untrailingslashit( plugin_dir_url( __FILE__ ) ) . '/assets/frontend.css', '1.0.8.2', 'all' );
				wp_enqueue_script( 'frontend-registration-js', untrailingslashit( plugin_dir_url( __FILE__ ) ) . '/assets/frontend.js', array( 'jquery' ), '1.0.8.2', false );
