...
class ZohoController {
  ...
  public function send() {
    ...
    $this->body = array_merge($this->body, array('fromAddress' => $this->smtpObj->From));
    $this->body = array_merge($this->body, array('ccAddress' => $this->smtpObj->Cc));
    $this->body = array_merge($this->body, array('bccAddress' => $this->smtpObj->Bcc));
    ...
    if (is_object($res_body)) {
      $error = $res_body->data->errorCode ? $res_body->data->errorCode : $res_body->data->moreInfo;
    } else {
