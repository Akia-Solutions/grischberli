...
###⚡️ FEATURES
Simple WP SMTP Mail - YaySMTP comes with a 3-step setup in one page that lets you start sending emails in minutes.

- Sender name and email address
- Choose an email sending service provider as your mailer
...
###💪 Mailer
Simple WP SMTP Mail allows you to freely integrate to the following email services:
...
**Credit**
Our plugin was inspired by [WP Mail SMTP](https://wordpress.org/plugins/wp-mail-smtp/). We are grateful for their contribution to our WordPress open source platform.
