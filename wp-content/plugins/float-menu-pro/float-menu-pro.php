	...
	final class Wow_Plugin {
		...
		public static function instance() {
			...
			if ( ! isset( self::$_instance ) && ! ( self::$_instance instanceof Wow_Plugin ) ) {
				...
				$info = array(
					'plugin' => array(
						'name'      => esc_attr( 'Float Menu Pro' ), // Plugin name
						'menu'      => esc_attr( 'Float Menu Pro' ), // Plugin name in menu
						...
						'store_url' => 'https://wow-estore.com/',
						'item_id'   => '5174',
					),
					'url'    => array(
						'author'   => 'https://wow-estore.com/',
						'home'     => 'https://wow-estore.com/item/float-menu-pro/',
						'support'  => 'https://wow-estore.com/item/float-menu-pro/#support',
						'facebook' => 'https://www.facebook.com/wowaffect/',
					),
					'rating' => array(
						'website'  => esc_attr__( 'Wow-Estore', 'float-menu' ), // Name site for rating plugin
						'url'      => 'https://wow-estore.com/item/float-menu-pro/#review',
				...
				self::$_instance->update = new Wow_Plugin_Update( $info );
			}
		...
		public function plugin_activate() {
			...
			deactivate_plugins( 'float-menu/float-menu.php' );
		}
