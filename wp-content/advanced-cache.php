...
$rocket_cache_path  = '/usr/www/users/grische/grischberli/wp-content/cache/wp-rocket/';
$rocket_config_path = '/usr/www/users/grische/grischberli/wp-content/wp-rocket-config/';

if ( file_exists( '/usr/www/users/grische/grischberli/wp-content/plugins/wp-rocket/inc/front/process.php' ) && version_compare( phpversion(), '5.4' ) >= 0 ) {

	spl_autoload_register( function( $class ) {
		$rocket_path    = '/usr/www/users/grische/grischberli/wp-content/plugins/wp-rocket/';
		$rocket_classes = [
	...
	include '/usr/www/users/grische/grischberli/wp-content/plugins/wp-rocket/inc/front/process.php';
} else {
